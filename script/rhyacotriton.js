...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.f60c2cf7e20d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__rO=new rhyacotriton.peers.Table(this.__kQ,this.__kO);
...
(function(){var e='undefined',d="rhyacotriton.BasicTable",c="Position ",b="object",a="Purge from the table entry by real id ";
...
},members:{__pE:null,__qc:null,__rP:null,__pG:null,__pH:null,__pI:null,setColumnNames:function(m){},getColumnNameToPositionIndex:function(){return this.__pG;
...
this.updateContent();
},__ql:function(G){for(var i in G){console.log(a+H);
var H=G[i];
...
(function(){var m="change selection",l="Port",k="Intersted",j="Pid",i="State",h="IP",g="Choking",f="rhyacotriton.peers.Table",e="Is choking?",d="changeSelection",a="dataLoadCompleted",c="Id",b="peerDataLoadCompleted";
qx.Class.define(f,{extend:rhyacotriton.BasicTable,construct:function(n,o){var q={"id":this.tr(j),"torrent_id":this.tr(c),"ip":this.tr(h),"port":this.tr(l),"state":this.tr(i),"choke_state":this.tr(g),"interest_state":this.tr(k),"local_choke":this.tr(e)};
rhyacotriton.BasicTable.call(this,q);
var r=this.getTableColumnModel();
var t=this.getColumnNameToPositionIndex();
r.setColumnWidth(t.id,70,true);
r.setColumnWidth(t.ip,90,true);
r.setColumnWidth(t.port,50,true);
r.setColumnWidth(t.torrent_id,30,true);
r.setColumnWidth(t.state,60,true);
r.setColumnWidth(t.interest_state,60,true);
r.setColumnWidth(t.choke_state,60,true);
r.setColumnWidth(t.local_choke,40,true);
r.setDataCellRenderer(t.local_choke,new qx.ui.table.cellrenderer.Boolean());
[t.interest_state,t.choke_state,t.local_choke].map(function(v){r.setColumnVisible(v,false);
});
var s=this.getTableModel();
s.setSortMethods(t.id,n.buildPidComparator(t.id));
s.setSortMethods(t.ip,n.buildIPComparator(t.ip));
n.addListener(b,this.getEventHandler(a),this);
var p=s.getView();
var u=s.addView(function(w){var x=w[t.torrent_id];
var y=o.getSelectedIds();
return (y.indexOf(x)!=-1);
},this);
o.getSelectionModel().addListener(d,function(){console.log(m);

if(o.getSelectedIds().length==0){this.setView(p);
}else{if(this.getView()!=u)this.setView(u);
this.updateView(u);
}},s);
},members:{}});
})();
