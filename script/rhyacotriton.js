...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.30f3c14ae949.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l='undefined',k="Bulk update.",h="Ls",g="dataUpdated",f="Out Before",e="total",d="seeders",c="rating",b="Speed Out",a="Left",W="sum_uploaded",V="Id",U="speed_out",T="downloaded",S="Ss",R="dataAdded",Q="all_time_uploaded",P="Total",O="leechers",N="Speed In",s="progress",t="uploaded",q="online",r="dataLoadCompleted",o="Total In",p="all_time_downloaded",m="In Now",n="name",u="sum_downloaded",v="Is the table empty?",C="left",A="Rating",G="state",E="Progress",J="Purge from the table entry by real id ",I="speed_in",x="In Before",M="Total Out",L="Name",K="rhyacotriton.Table",w="Out Now",y="Position ",z="dataRemoved",B="State",D="dataRemoveFailure",F="On-line",H="id";
qx.Class.define(K,{extend:qx.ui.table.Table,construct:function(X){this.__kL=X;
var Y=this;
this.__pp=new smart.model.Default;
this.__rh={"id":V,"name":L,"total":P,"left":a,"progress":E,"rating":A,"online":F,"seeders":S,"leechers":h,"state":B,"downloaded":m,"uploaded":w,"all_time_downloaded":x,"all_time_uploaded":f,"sum_downloaded":o,"sum_uploaded":M,"speed_in":N,"speed_out":b},this.__rm=[];
this.__ri=[];
this.__rj=[];
var i=0;

for(var name in this.__rh){var ba=this.__rh[name];
this.__rm[name]=i;
this.__ri[i]=name;
this.__rj[i]=ba;
i++;
}delete i;
console.dir(this.__rj);
console.dir(this.__ri);
this.__pp.setColumns(this.__rj,this.__ri);
qx.ui.table.Table.call(this,this.__pp);
this.__pf=this.getTableColumnModel();
this.__pv=this.__pp.getColumnIndexById(H);
this.__qL=this.__pp.getColumnIndexById(n);
this.__pq=this.__pp.getColumnIndexById(q);
this.__pr=this.__pp.getColumnIndexById(C);
this.__ps=this.__pp.getColumnIndexById(e);
this.__pt=this.__pp.getColumnIndexById(s);
this.__qM=this.__pp.getColumnIndexById(O);
this.__qN=this.__pp.getColumnIndexById(d);
this.__qU=this.__pp.getColumnIndexById(T);
this.__qV=this.__pp.getColumnIndexById(t);
this.__qX=this.__pp.getColumnIndexById(u);
this.__qY=this.__pp.getColumnIndexById(W);
this.__rc=this.__pp.getColumnIndexById(p);
this.__rd=this.__pp.getColumnIndexById(Q);
this.__qR=this.__pp.getColumnIndexById(c);
this.__qW=this.__pp.getColumnIndexById(G);
this.__rf=this.__pp.getColumnIndexById(I);
this.__rg=this.__pp.getColumnIndexById(U);
...
this.__pf.setDataCellRenderer(this.__pt,new rhyacotriton.cellrenderer.Progress());
this.__pf.setDataCellRenderer(this.__qR,new rhyacotriton.cellrenderer.Rating());
this.__pf.setDataCellRenderer(this.__pq,new qx.ui.table.cellrenderer.Boolean());
[this.__ps,this.__pr,this.__qU,this.__qV,this.__rc,this.__rd,this.__qX,this.__qY].map(function(bb){Y.__pf.setDataCellRenderer(bb,new rhyacotriton.cellrenderer.Size());
});
...
[this.__pr,this.__qU,this.__qV,this.__rc,this.__rd,this.__pq].map(function(bc){Y.__pf.setColumnVisible(bc,false);
});
...
this.__kL.addListener(R,this.__qO,this);
this.__kL.addListener(z,this.__py,this);
this.__kL.addListener(D,this.__pz,this);
this.__kL.addListener(r,this.__px,this);
this.__kL.addListener(g,this.__pA,this);
},members:{__kL:null,__pv:null,__qL:null,__pq:null,__pr:null,__ps:null,__pt:null,__qM:null,__qN:null,__qW:null,__qR:null,__rc:null,__rd:null,__qU:null,__qV:null,__qX:null,__qY:null,__rf:null,__rg:null,__pp:null,__pf:null,__pu:null,__qS:function(bd){var bf=bd[this.__ps];
var bg=bd[this.__pr];
var be=bf-bg;
return ((be/bf)*100).toFixed(2);
},__qT:function(bh){var bn=bh[this.__qV];
var bi=bh[this.__qU];
var bl=bh[this.__rd];
var bk=bh[this.__rc];
var bm=bi+bk;
...
if(bm==0)return 0;
return (bj/bm).toFixed(2);
},__ra:function(bo){var bp=bo[this.__qU];
var bq=bo[this.__rc];
return bp+bq;
},__rb:function(br){var bs=br[this.__qV];
var bt=br[this.__rd];
return bs+bt;
},logSelectedRows:function(){var bu=this.__pp;
this.__pu.iterateSelection(function(bv){console.log(y+bv);
console.dir(bu.getRowData(bv));
});
},getSelectedIds:function(){var bx=[];
var bw=this;
this.__pu.iterateSelection(function(by){bx.push(bw.__pp.getValue(bw.__pv,by));
});
return bx;
...
},__px:function(event){var bz=event.getData();

try{this.__pp.removeRows(0,undefined,undefined,false);
}catch(bA){console.log(v);
}this.__rk(bz.rows);
},__qO:function(event){var bB=event.getData();
this.__rk(bB);
},__rk:function(bC){var bD=[];

for(var i in bC){var bE=bC[i];
bD[i]=this.__rl(bE,[]);
}console.log(k);
console.dir(bD);
this.__pp.setData(bD);
this.updateContent();
},removeSelectedRows:function(){this.info("RemoveSelectedRows");
this.logSelectedRows();
var bF=this;
var bG=this.getSelectedIds();
this.__re(bG);
},__py:function(event){var bH=event.getData().rows;
this.__re(bH);
},__re:function(bI){for(var i in bI){console.log(J+bJ);
var bJ=bI[i];
var bK=this.__pp.locate(this.__pv,bJ);
if(bK!=l)this.__pp.removeRows(bK,1);
}},__pz:function(event){var bL=event.getOldData();
this.__pp.addRowsAsMapArray([bL]);
},particallyUpdateRows:function(bM){for(var i=0,bN=bM.length;i<bN;i++){var bR=bM[i];

if(typeof (bR.id)==l)this.error("Cannot get Rows[i].id");
var bQ=this.__pp.locate(this.__pv,bR.id);
var bO=this.__pp.getRowData(bQ,undefined,false);
var bP=bO.slice(0);
bP=this.__rl(bR,bP);
bQ=this.__pp.locate(this.__pv,bR.id);
this.__pp.setRow(bQ,bP);
}},__rl:function(bS,bT){for(var j in bS){var bU=this.__rm[j];
bT[bU]=bS[j];
}bT[this.__qY]=this.__rb(bT);
bT[this.__qX]=this.__ra(bT);
bT[this.__qR]=this.__qT(bT);
bT[this.__pt]=this.__qS(bT);
return bT;
...
qx.Class.define(a,{extend:qx.ui.table.cellrenderer.Conditional,members:{__qw:null,_getContentHtml:function(d){return d.rowData[d.col]+c;
