...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.07d6d68dfee1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="id",k="total",h="seeders",g='undefined',f="downloaded",e="rating",d="leechers",c="progress",b="uploaded",a="online",O="all_time_downloaded",N="all_time_uploaded",M="left",L="state",K="name",J="Position ",I="Uploaded",H="Downloaded",G="Total",F="Left",s="Total downloaded",t="Id",q="Ss",r="dataAdded",o="%",p="dataLoadCompleted",m="Ls",n="Total uploaded",u="Is the table empty?",v="Rating",y="Progress",x="Purge from the table entry by real id ",A="dataUpdated",z="Name",C="rhyacotriton.Table",B="dataRemoved",w="State",E="dataRemoveFailure",D="On-line";
qx.Class.define(C,{extend:qx.ui.table.Table,construct:function(P){this.__kL=P;
var Q=this;
this.__pp=new smart.model.Default;
this.__pp.setColumns([t,z,G,F,y,v,D,q,m,H,I,w,n,s],[l,K,k,M,c,e,a,h,d,f,b,L,N,O]);
...
this.__pq=this.__pp.getColumnIndexById(a);
this.__pr=this.__pp.getColumnIndexById(M);
this.__ps=this.__pp.getColumnIndexById(k);
this.__pt=this.__pp.getColumnIndexById(c);
this.__qM=this.__pp.getColumnIndexById(d);
this.__qN=this.__pp.getColumnIndexById(h);
this.__qU=this.__pp.getColumnIndexById(f);
this.__qV=this.__pp.getColumnIndexById(b);
this.__qP=this.__pp.getColumnIndexById(O);
this.__qQ=this.__pp.getColumnIndexById(N);
this.__qR=this.__pp.getColumnIndexById(e);
this.__qW=this.__pp.getColumnIndexById(L);
this.__pf.setColumnVisible(this.__pq,false);
this.__pf.setColumnVisible(this.__pr,false);
...
this.__pf.setColumnWidth(this.__qP,70,true);
this.__pf.setColumnWidth(this.__qQ,70,true);
this.__pf.setColumnWidth(this.__qU,70,true);
this.__pf.setColumnWidth(this.__qV,70,true);
var R=function(T){return Q.__qS(T);
};
var S=function(U){return Q.__qT(U);
};
this.__pf.setDataCellRenderer(this.__pt,new rhyacotriton.cellrenderer.Progress(R));
this.__pf.setDataCellRenderer(this.__qR,new rhyacotriton.cellrenderer.Rating(S));
this.__pf.setDataCellRenderer(this.__pq,new qx.ui.table.cellrenderer.Boolean());
[this.__ps,this.__pr,this.__qU,this.__qV,this.__qP,this.__qQ].map(function(V){Q.__pf.setDataCellRenderer(V,new rhyacotriton.cellrenderer.Size());
});
...
this.__kL.addListener(E,this.__pz,this);
this.__kL.addListener(p,this.__px,this);
this.__kL.addListener(A,this.__pA,this);
},members:{__kL:null,__pv:null,__qL:null,__pq:null,__pr:null,__ps:null,__pt:null,__qM:null,__qN:null,__qW:null,__qR:null,__qP:null,__qQ:null,__qU:null,__qV:null,__pp:null,__pf:null,__pu:null,__qS:function(W){var Y=W[this.__ps];
var ba=W[this.__pr];
var X=Y-ba;
return ((X/Y)*100).toFixed(2)+o;
},__qT:function(bb){var bd=bb[this.__qQ];
var bc=bb[this.__qP];

if(bc==0)return 0;
return (bd/bc).toFixed(2);
},logSelectedRows:function(){var be=this.__pp;
this.__pu.iterateSelection(function(bf){console.log(J+bf);
console.dir(be.getRowData(bf));
});
},getSelectedIds:function(){var bh=[];
var bg=this;
this.__pu.iterateSelection(function(bi){bh.push(bg.__pp.getValue(bg.__pv,bi));
});
return bh;
},removeSelectedRows:function(){this.info("RemoveSelectedRows");
this.logSelectedRows();
var bj=this;
this.__pu.iterateSelection(function(bk){console.log(J+bk);
var bl=bj.__pp.getRowDataAsMap(bk);
bj.__kL.removeElement(bl);
bj.__pp.removeRows(bk,1);
});
...
},__px:function(event){var bm=event.getData();

try{this.__pp.removeRows(0,undefined,undefined,false);
}catch(bn){console.log(u);
}this.__pp.setDataAsMapArray(bm.rows);
this.updateContent();
},__qO:function(event){var bo=event.getData();
this.__pp.setDataAsMapArray(bo.rows);
this.updateContent();
},__py:function(event){var bp=event.getData().rows;

for(var i in bp){console.log(x+bq);
var bq=bp[i];
var br=this.__pp.locate(this.__pv,bq);
if(br!=g)this.__pp.removeRows(br,1);
}},__pz:function(event){var bs=event.getOldData();
this.__pp.addRowsAsMapArray([bs]);
},particallyUpdateRows:function(bt){for(var i=0,bu=bt.length;i<bu;i++){var bx=bt[i];

if(typeof (bx.id)==g)this.error("Cannot get Rows[i].id");
var bw=this.__pp.locate(this.__pv,bx.id);

for(var j in bx){if(j==l)continue;
var bv=this.__pp.getColumnIndexById(j);
this.__pp.setValue(bv,bw,bx[j]);
}}},__pA:function(event){var by=event.getData();
this.particallyUpdateRows(by.rows);
this.updateContent();
}}});
})();
