...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.98f9f306f2dd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="id",k="name",h="total",g="seeders",f="rating",e="sum_uploaded",d='undefined',c="downloaded",b="leechers",a="progress",S="uploaded",R="online",Q="sum_downloaded",P="all_time_downloaded",O="all_time_uploaded",N="left",M="state",L="Position ",K="Left",J="Uploaded Now",s="Downloaded Before",t="Total downloaded",q="Id",r="Ss",o="dataAdded",p="%",m="Total",n="dataLoadCompleted",u="Ls",v="Total uploaded",B="Is the table empty?",A="Rating",D="Progress",C="Purge from the table entry by real id ",F="dataUpdated",E="Downloaded Now",x="Name",I="rhyacotriton.Table",H="dataRemoved",G="State",w="dataRemoveFailure",y="On-line",z="Uploaded Before";
qx.Class.define(I,{extend:qx.ui.table.Table,construct:function(T){this.__kL=T;
var U=this;
this.__pp=new smart.model.Default;
this.__pp.setColumns([q,x,m,K,D,A,y,r,u,G,E,J,z,s,t,v],[l,k,h,N,a,f,R,g,b,M,c,S,O,P,Q,e]);
...
this.__pq=this.__pp.getColumnIndexById(R);
this.__pr=this.__pp.getColumnIndexById(N);
this.__ps=this.__pp.getColumnIndexById(h);
this.__pt=this.__pp.getColumnIndexById(a);
this.__qM=this.__pp.getColumnIndexById(b);
this.__qN=this.__pp.getColumnIndexById(g);
this.__qU=this.__pp.getColumnIndexById(c);
this.__qV=this.__pp.getColumnIndexById(S);
this.__qX=this.__pp.getColumnIndexById(Q);
this.__qY=this.__pp.getColumnIndexById(e);
...
this.__kL.addListener(o,this.__qO,this);
this.__kL.addListener(H,this.__py,this);
this.__kL.addListener(w,this.__pz,this);
this.__kL.addListener(n,this.__px,this);
...
var bj=bg[this.__pr];
var bh=bi-bj;
return ((bh/bi)*100).toFixed(2)+p;
},__qT:function(bk){var bq=bk[this.__qV];
var bl=bk[this.__qU];
var bo=bk[this.__rd];
var bn=bk[this.__rc];
var bp=bl+bn;
...
if(bp==0)return 0;
return (bm/bp).toFixed(2);
},__ra:function(br){var bs=br[this.__qU];
var bt=br[this.__rc];
return bs+bt;
},__rb:function(bu){var bv=bu[this.__qV];
var bw=bu[this.__rd];
return bv+bw;
},logSelectedRows:function(){var bx=this.__pp;
this.__pu.iterateSelection(function(by){console.log(L+by);
console.dir(bx.getRowData(by));
});
},getSelectedIds:function(){var bA=[];
var bz=this;
this.__pu.iterateSelection(function(bB){bA.push(bz.__pp.getValue(bz.__pv,bB));
});
return bA;
},removeSelectedRows:function(){this.info("RemoveSelectedRows");
this.logSelectedRows();
var bC=this;
this.__pu.iterateSelection(function(bD){console.log(L+bD);
var bE=bC.__pp.getRowDataAsMap(bD);
bC.__kL.removeElement(bE);
bC.__pp.removeRows(bD,1);
});
...
},__px:function(event){var bF=event.getData();

try{this.__pp.removeRows(0,undefined,undefined,false);
}catch(bG){console.log(B);
}this.__pp.setDataAsMapArray(bF.rows);
this.updateContent();
},__qO:function(event){var bH=event.getData();
this.__pp.setDataAsMapArray(bH.rows);
this.updateContent();
},__py:function(event){var bI=event.getData().rows;

for(var i in bI){console.log(C+bJ);
var bJ=bI[i];
var bK=this.__pp.locate(this.__pv,bJ);
if(bK!=d)this.__pp.removeRows(bK,1);
}},__pz:function(event){var bL=event.getOldData();
this.__pp.addRowsAsMapArray([bL]);
},particallyUpdateRows:function(bM){for(var i=0,bN=bM.length;i<bN;i++){var bQ=bM[i];

if(typeof (bQ.id)==d)this.error("Cannot get Rows[i].id");
var bP=this.__pp.locate(this.__pv,bQ.id);

for(var j in bQ){if(j==l)continue;
var bO=this.__pp.getColumnIndexById(j);
this.__pp.setValue(bO,bP,bQ[j]);
}}},__pA:function(event){var bR=event.getData();
this.particallyUpdateRows(bR.rows);
this.updateContent();
}}});
})();
