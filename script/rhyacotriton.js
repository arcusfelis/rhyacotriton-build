...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.b4bfc685ad7f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="id",k="sum_downloaded",h="total",g="seeders",f="rating",e='undefined',d="sum_uploaded",c="speed_out",b="downloaded",a="leechers",W="progress",V="uploaded",U="online",T="all_time_downloaded",S="name",R="all_time_uploaded",Q="left",P="state",O="speed_in",N="Ls",s="dataUpdated",t="Out Before",q="Speed Out",r="Left",o="Id",p="Ss",m="dataAdded",n="%",u="Total",v="Speed In",C="dataLoadCompleted",A="Total In",G="In Now",E="Is the table empty?",J="Rating",I="Progress",x="Purge from the table entry by real id ",M="In Before",L="Total Out",K="Name",w="rhyacotriton.Table",y="Out Now",z="Position ",B="dataRemoved",D="State",F="dataRemoveFailure",H="On-line";
qx.Class.define(w,{extend:qx.ui.table.Table,construct:function(X){this.__kL=X;
var Y=this;
this.__pp=new smart.model.Default;
this.__pp.setColumns([o,K,u,r,I,J,H,p,N,D,G,y,M,t,A,L,v,q],[l,S,h,Q,W,f,U,g,a,P,b,V,R,T,k,d,O,c]);
qx.ui.table.Table.call(this,this.__pp);
this.__pf=this.getTableColumnModel();
this.__pv=this.__pp.getColumnIndexById(l);
this.__qL=this.__pp.getColumnIndexById(S);
this.__pq=this.__pp.getColumnIndexById(U);
this.__pr=this.__pp.getColumnIndexById(Q);
this.__ps=this.__pp.getColumnIndexById(h);
this.__pt=this.__pp.getColumnIndexById(W);
this.__qM=this.__pp.getColumnIndexById(a);
this.__qN=this.__pp.getColumnIndexById(g);
this.__qU=this.__pp.getColumnIndexById(b);
this.__qV=this.__pp.getColumnIndexById(V);
this.__qX=this.__pp.getColumnIndexById(k);
this.__qY=this.__pp.getColumnIndexById(d);
this.__rc=this.__pp.getColumnIndexById(T);
this.__rd=this.__pp.getColumnIndexById(R);
this.__qR=this.__pp.getColumnIndexById(f);
this.__qW=this.__pp.getColumnIndexById(P);
this.__rf=this.__pp.getColumnIndexById(O);
this.__rg=this.__pp.getColumnIndexById(c);
this.__pf.setColumnWidth(this.__qL,250,true);
this.__pf.setColumnWidth(this.__pv,30,true);
this.__pf.setColumnWidth(this.__pt,65,true);
...
this.__pf.setColumnWidth(this.__qR,60,true);
this.__pf.setColumnWidth(this.__rc,65,true);
...
this.__pf.setColumnWidth(this.__qX,70,true);
this.__pf.setColumnWidth(this.__qY,70,true);
this.__pf.setColumnWidth(this.__rf,70,true);
this.__pf.setColumnWidth(this.__rg,70,true);
var ba=function(be){return Y.__qS(be);
};
var bc=function(bf){return Y.__qT(bf);
};
this.__pf.setDataCellRenderer(this.__pt,new rhyacotriton.cellrenderer.Progress(ba));
this.__pf.setDataCellRenderer(this.__qR,new rhyacotriton.cellrenderer.Rating(bc));
this.__pf.setDataCellRenderer(this.__pq,new qx.ui.table.cellrenderer.Boolean());
[this.__ps,this.__pr,this.__qU,this.__qV,this.__rc,this.__rd].map(function(bg){Y.__pf.setDataCellRenderer(bg,new rhyacotriton.cellrenderer.Size());
});
var bd=function(bh){return Y.__ra(bh);
};
var bb=function(bi){return Y.__rb(bi);
};
Y.__pf.setDataCellRenderer(this.__qX,new rhyacotriton.cellrenderer.Size(bd));
Y.__pf.setDataCellRenderer(this.__qY,new rhyacotriton.cellrenderer.Size(bb));
Y.__pf.setDataCellRenderer(this.__rf,new rhyacotriton.cellrenderer.Speed());
Y.__pf.setDataCellRenderer(this.__rg,new rhyacotriton.cellrenderer.Speed());
[this.__pr,this.__qU,this.__qV,this.__rc,this.__rd,this.__pq].map(function(bj){Y.__pf.setColumnVisible(bj,false);
});
...
this.__kL.addListener(m,this.__qO,this);
this.__kL.addListener(B,this.__py,this);
this.__kL.addListener(F,this.__pz,this);
this.__kL.addListener(C,this.__px,this);
this.__kL.addListener(s,this.__pA,this);
},members:{__kL:null,__pv:null,__qL:null,__pq:null,__pr:null,__ps:null,__pt:null,__qM:null,__qN:null,__qW:null,__qR:null,__rc:null,__rd:null,__qU:null,__qV:null,__qX:null,__qY:null,__rf:null,__rg:null,__pp:null,__pf:null,__pu:null,__qS:function(bk){var bm=bk[this.__ps];
var bn=bk[this.__pr];
var bl=bm-bn;
return ((bl/bm)*100).toFixed(2)+n;
},__qT:function(bo){var bu=bo[this.__qV];
var bp=bo[this.__qU];
var bs=bo[this.__rd];
var br=bo[this.__rc];
var bt=bp+br;
...
if(bt==0)return 0;
return (bq/bt).toFixed(2);
},__ra:function(bv){var bw=bv[this.__qU];
var bx=bv[this.__rc];
return bw+bx;
},__rb:function(by){var bz=by[this.__qV];
var bA=by[this.__rd];
return bz+bA;
},logSelectedRows:function(){var bB=this.__pp;
this.__pu.iterateSelection(function(bC){console.log(z+bC);
console.dir(bB.getRowData(bC));
});
},getSelectedIds:function(){var bE=[];
var bD=this;
this.__pu.iterateSelection(function(bF){bE.push(bD.__pp.getValue(bD.__pv,bF));
});
return bE;
...
},__px:function(event){var bG=event.getData();

try{this.__pp.removeRows(0,undefined,undefined,false);
}catch(bH){console.log(E);
}this.__pp.setDataAsMapArray(bG.rows);
this.updateContent();
},__qO:function(event){var bI=event.getData();
this.__pp.setDataAsMapArray(bI.rows);
this.updateContent();
},removeSelectedRows:function(){this.info("RemoveSelectedRows");
this.logSelectedRows();
var bJ=this;
var bK=this.getSelectedIds();
this.__re(bK);
},__py:function(event){var bL=event.getData().rows;
this.__re(bL);
},__re:function(bM){for(var i in bM){console.log(x+bN);
var bN=bM[i];
var bO=this.__pp.locate(this.__pv,bN);
if(bO!=e)this.__pp.removeRows(bO,1);
}},__pz:function(event){var bP=event.getOldData();
this.__pp.addRowsAsMapArray([bP]);
},particallyUpdateRows:function(bQ){for(var i=0,bR=bQ.length;i<bR;i++){var bU=bQ[i];

if(typeof (bU.id)==e)this.error("Cannot get Rows[i].id");
var bT=this.__pp.locate(this.__pv,bU.id);

for(var j in bU){if(j==l)continue;
var bS=this.__pp.getColumnIndexById(j);
this.__pp.setValue(bS,bT,bU[j]);
}}},__pA:function(event){var bV=event.getData();
this.particallyUpdateRows(bV.rows);
this.updateContent();
}}});
})();
...
(function(){var f=' MiB/s',e="qooxdoo-table-cell-right qooxdoo-table-cell",d='0',c=' B/s',b="rhyacotriton.cellrenderer.Speed",a=' KiB/s';
qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Conditional,members:{__qw:undefined,_getContentHtml:function(g){var h;
h=g.rowData[g.col];
return this.bytesToSize(h,0);
},_getCellClass:function(i){return e;
},bytesToSize:function(j,k){if(isNaN(j)||(j==0))return d;
var l=1024;
var m=l*1024;
var n=m*1024;
var o=n*1024;

if((j>=0)&&(j<l)){return j+c;
}else if((j>=l)&&(j<m)){return (j/l).toFixed(k)+a;
}else{return (j/m).toFixed(k)+f;
}}}});
})();
