...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rhyacotriton.cfb5db81cf9c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="id",k="name",h="total",g="seeders",f="rating",e="sum_uploaded",d='undefined',c="downloaded",b="leechers",a="progress",S="uploaded",R="online",Q="sum_downloaded",P="all_time_downloaded",O="all_time_uploaded",N="left",M="state",L="Left",K="Uploaded Now",J="Downloaded Before",s="Total downloaded",t="Id",q="Ss",r="dataAdded",o="%",p="Total",m="dataLoadCompleted",n="Ls",u="Total uploaded",v="Is the table empty?",B="Rating",A="Progress",D="Purge from the table entry by real id ",C="dataUpdated",F="Downloaded Now",E="Name",x="rhyacotriton.Table",I="Position ",H="dataRemoved",G="State",w="dataRemoveFailure",y="On-line",z="Uploaded Before";
qx.Class.define(x,{extend:qx.ui.table.Table,construct:function(T){this.__kL=T;
var U=this;
this.__pp=new smart.model.Default;
this.__pp.setColumns([t,E,p,L,A,B,y,q,n,G,F,K,z,J,s,u],[l,k,h,N,a,f,R,g,b,M,c,S,O,P,Q,e]);
...
this.__kL.addListener(m,this.__px,this);
this.__kL.addListener(C,this.__pA,this);
...
this.__pu.iterateSelection(function(by){console.log(I+by);
...
},__px:function(event){var bC=event.getData();

try{this.__pp.removeRows(0,undefined,undefined,false);
}catch(bD){console.log(v);
}this.__pp.setDataAsMapArray(bC.rows);
this.updateContent();
},__qO:function(event){var bE=event.getData();
this.__pp.setDataAsMapArray(bE.rows);
this.updateContent();
...
this.__re(bH);
},__re:function(bI){for(var i in bI){console.log(D+bJ);
var bJ=bI[i];
